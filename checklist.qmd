...
2. You (and your partner, if you have one) will present your project on December 3-9 to Dr. Love in his office or over Zoom. Details on the Oral Presentation are provided below. The [Project Presentation Schedule is here](https://github.com/THOMASELOVE/431-classes-2025/blob/main/projectB/schedule.md)!
...
Your Study 1 Report is to be submitted [to Canvas](https://canvas.case.edu/) by the deadline in [the Course Calendar](https://thomaselove.github.io/431-2025/calendar.html).
...
Your Study 2 Report is to be submitted to [to Canvas](https://canvas.case.edu/) by the deadline in [the Course Calendar](https://thomaselove.github.io/431-2025/calendar.html).
...
The Form is due when the Project B Portfolio is due, and you'll complete it **after** meeting with Dr. Love for your presentation. Find [the link to the Self-Evaluation Form here](self_eval.qmd).
